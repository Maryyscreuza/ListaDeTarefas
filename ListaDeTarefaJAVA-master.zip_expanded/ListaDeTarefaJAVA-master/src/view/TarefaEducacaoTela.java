...
public class TarefaEducacaoTela extends JFrame {
	...
	public TarefaEducacaoTela() {
		super("Tarefa Educação");
	
	Font fonte = new Font("Serif", Font.PLAIN, 20);
	JLabel label = new JLabel("Tarefas Educação");
	label.setFont(fonte);
