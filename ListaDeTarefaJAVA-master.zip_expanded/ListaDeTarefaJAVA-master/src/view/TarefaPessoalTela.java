...
public class TarefaPessoalTela extends JFrame  {
	...
	public TarefaPessoalTela() {
		super("Tarefa Pessoal");

		Font fonte = new Font("Serif", Font.PLAIN, 20);
		JLabel label = new JLabel("Tarefas Pessoal");
		label.setFont(fonte);
